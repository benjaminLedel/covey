---
slug: companion
title: Die Companion-App
description: 'Der Ausblick: eine App, in der Menschen Wissen abladen, ein Kurator-Agent es zu Wiki-Seiten verdichtet und Freigegebenes als Kontext zu den Agenten fließt.'
---
...
Der Apparat existiert bereits: [Das Wiki-Gedächtnis](../concepts/memory.md) der Agenten ist genau dieses Modell — verlinkte Seiten, Vektorindex, Verdichtung. Der Companion setzt einen Menschen als Eigentümer an die Stelle des Agenten.
