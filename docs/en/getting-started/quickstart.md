...
[`ops-workplaces.md`](../operations/workplaces.md) says which one an agent belongs in.
...
([`ops-zammad.md`](../integrations/zammad.md), [`ops-github.md`](../integrations/github.md),
[`ops-email.md`](../integrations/email.md) …) or by importing one of the ready-made bundles
...
[`ops-deployment.md`](../operations/deployment.md).
