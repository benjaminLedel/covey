...
slug: browser
title: Browser
description: 'A full headless Chrome as a universal adapter for web applications with no target-system plugin of their own: the agent navigates, reads, clicks and types like a user.'
---
