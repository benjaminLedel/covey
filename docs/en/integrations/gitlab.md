...
([`ops-zammad.md`](./zammad.md)) — the unit of work here is the
...
> through the built-in egress templates) — see [`operations/deployment.md`](../operations/deployment.md).
...
[`ops-zammad.md`](./zammad.md), section 6.
