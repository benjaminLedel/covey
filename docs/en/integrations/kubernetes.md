...
slug: kubernetes
title: Kubernetes
description: 'A Kubernetes cluster as a target system: why a pod restarts, what it said before it died, where an Ingress actually points. Read-only, from the catalogue.'
---
