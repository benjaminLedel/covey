...
description: 'The outlook: an app where people offload their knowledge, a curator agent distils it into linked wiki pages, and shared knowledge flows as context into the agents'' work.'
---
...
The apparatus already exists: the agents' [wiki memory](../concepts/memory.md) is exactly this model — linked pages, vector index, consolidation. The Companion puts a person in the owner's place instead of an agent.
