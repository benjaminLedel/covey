...
- **No employer reach-through by default.** No admin, no manager reads the personal dump. A platform admin sees existence/metadata (offboarding), never content. Access to content only through a defined, logged compliance process (legal hold), ideally under four-eyes control — never casually.
