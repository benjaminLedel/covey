...
**The second case has turned up.** The improvement engineer proposes changes to the configurations of colleagues it did not draft, and there the inactive version is not a gentler variant but the only defensible one — see [`21-operations-and-improvement.md`](21-operations-and-improvement.md). Once it exists, the self-proposal above costs nothing more than allowing it.
