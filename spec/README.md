...
| [`16-runner.md`](16-runner.md) | Verteilte Data Plane: registrierte Runner nach GitLab-Vorbild, Runner-Protokoll, Home-Affinität, Sandbox-Images pro Agent, Vertrauensgrenze |
