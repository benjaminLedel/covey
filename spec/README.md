...
| [`16-runner.md`](16-runner.md) | Verteilte Data Plane: registrierte Runner nach GitLab-Vorbild, Runner-Protokoll, das Home als verwerfbarer Arbeitsbestand, Sandbox-Images pro Agent, Vertrauensgrenze |
