...
| [`21-feedback-and-development.md`](21-feedback-and-development.md) | The other half of the People department: the personnel file as recorded evidence, config changes as proposals a human accepts, issues against the platform itself |
...
- **People department** — The org-owned department whose subject is the other agents. Two roles: **hiring**, which turns a person's description of a job into a complete agent config and drafts the agent ([`20-hiring-and-setup.md`](20-hiring-and-setup.md)), and **development**, which reads what a hired colleague actually did and proposes what to change ([`21-feedback-and-development.md`](21-feedback-and-development.md)). Config as code instead of a hardcoded generation call — the same principle as the memory curator.
- **Personnel file** — The condensed record the control plane assembles about one agent over a period: throughput, aborts, executed actions, indicators, cost, friction, lint findings. Facts it recorded itself, not text the agent or a target system produced. See [`21-feedback-and-development.md`](21-feedback-and-development.md).
