...
The rules are mechanical, and that is their strength and their ceiling: they see the pattern and not the case. The reader that judges the case is the improvement engineer, which takes these findings as one input among several ([`21-operations-and-improvement.md`](21-operations-and-improvement.md)).
