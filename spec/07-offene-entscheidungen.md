...
Daraus folgt die Rolle des Runners: **Affinität ist eine Scheduling-Präferenz, keine Bindung.** Der Scheduler bevorzugt den Runner, auf dem der Agent zuletzt lief, weil dort Checkouts und Caches warm liegen; fehlt er, wacht der Agent woanders auf. Ein kalter Start kostet Minuten — aber Zeit, nicht Arbeit. Ein Runner-Ausfall macht einen Agenten langsam, nicht arbeitsunfähig, und Failover fällt ohne eigenen Mechanismus ab.
