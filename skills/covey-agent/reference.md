...
|---|---|---|
| `gitlab` | `read,write,comment` | Issues/MRs: list_issues, get_issue, checkout, read_file, create_issue, comment, list_notes, assign, set_state, commit, create_merge_request, comment_mr, approve_mr, upload, download_upload |
