...
| `delivery-lead.bundle.json` | Delivery Lead: einen GitLab-Meilenstein zur Frist führen — Tickets aufbereiten, Reihenfolge halten, an Entwickler-Kollegen vergeben, Stand berichten. Vorhabensspezifisches steht in einem Steckbrief im Wiki (Vorlage: `examples/vorhaben-steckbrief.md` im Repo), nicht in der Config |
