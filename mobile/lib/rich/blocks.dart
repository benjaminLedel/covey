...
/// quotes, dividers, tables and pictures.
///
...
enum BlockKind { paragraph, heading1, heading2, heading3, bullet, numbered, todo, quote, divider, table, image }

class Block {
  Block(this.kind, {this.text = '', this.checked = false, this.rows, this.ref = ''});
  ...
  Block copy() => Block(kind, text: text, checked: checked, rows: rows?.map((r) => [...r]).toList(), ref: ref);
}
