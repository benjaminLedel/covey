...
const icons: Record<string, JSX.Element> = {
  ...
  // The office (#390): a building with windows and a door.
  office: (
    <>
      <path d="M4 20.5V6.5L12 3l8 3.5v14" />
      <path d="M2.5 20.5h19" />
      <path d="M8 9h2M14 9h2M8 12.5h2M14 12.5h2" />
      <path d="M10.5 20.5v-4h3v4" />
    </>
  ),
  // Administration (#390): a panel of sliders.
  sliders: (
    <>
