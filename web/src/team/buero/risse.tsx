...
const BILDER: Record<Art, Bild> = {
  ...
  schrank: { vb: "0 0 34 13", d: ["M.6 .6h32.8v11.8H.6Z", "M17 .6v11.8", "M8 7h4", "M22 7h4"] },
  ...
  whiteboard: { vb: "0 0 45 8", d: ["M.7 .7h43.6v6.6H.7Z", "M6 4h16", "M6 5.8h9"] },
  uhr: { vb: "0 0 24 14", d: ["M12 1.2a5.8 5.8 0 1 1 0 11.6 5.8 5.8 0 0 1 0-11.6Z", "M12 4v3l2.4 1.6"] },
  sofa: {
    vb: "0 0 44 24",
    d: [
  ...
  telefon: { vb: "0 0 12 9", d: ["M.7 1.7h10.6v6.6H.7Z", "M2.6 .8c1.4-.8 4.4-.8 5.8 0"] },
  zweitschirm: { vb: "0 0 14 7", d: ["M.7 .7h12.6v5.6H.7Z"] },
  lampe: { vb: "0 0 12 12", d: ["M6 11V5", "M2.4 5 6 .9 9.6 5Z", "M3 11.4h6"] },
  papierkorb: { vb: "0 0 10 10", d: ["M1.4 1.6h7.2l-.9 7a1 1 0 0 1-1 .8H3.3a1 1 0 0 1-1-.8Z"] },
  tasse: { vb: "0 0 14 12", d: ["M2 3h8v5a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2Z", "M10 4.5h1.5a1.5 1.5 0 0 1 0 3H10"] },
  mappe: { vb: "0 0 14 11", d: ["M1.5 2.5h10v7.5h-10Z", "M4 1.5h9v6.5"] },
  drucker: { vb: "0 0 24 18", d: ["M2 4h20v9H2Z", "M6 0h12v4H6Z", "M6 13h12v5H6Z", "M18 7h2"] },
  ...
  flieger: { vb: "0 0 22 12", d: ["M0 6 22 0l-8 12-3-5Z", "M11 7 22 0"] },
  paket: { vb: "0 0 18 18", d: ["M1 3.4h16v13.2H1Z", "M9 3.4v13.2", "M1 8.2h16"] },
  kuchen: { vb: "0 0 22 20", d: ["M11 3.4a7.6 7.6 0 1 1 0 15.2 7.6 7.6 0 0 1 0-15.2Z", "M11 11 17 7.6", "M11 11v7.6", "M11 3.4V.8"] },
  blatt: { vb: "0 0 10 13", d: ["M.7 .7h8.6v11.6H.7Z", "M2.6 4h4.8", "M2.6 6.4h4.8", "M2.6 8.8h3"] },
  vogel: { vb: "0 0 13 12", d: ["M3 6a3 3 0 0 1 6 0c0 2-1.5 3.4-3 3.4S3 8 3 6Z", "M9 5.2 12 4", "M3.4 5 .6 3.4", "M6 9.4v1.6"] },
};
...
export default function Riss({
  ...
  const inhalt = bild.d.map((d, i) => <path key={i} d={d} />);
