...
function Zeile({ w, me }: { w: Workplace; me: Principal }) {
  ...
  return (
    <div className="card mb-3">
      ...
      {/* And which of them still stands in the old image. Nothing here
          restarts anything: pulling the sandbox out from under a running agent
          is worse than an old digest. The decision stays with a person, who was
          only missing the information (#217). */}
      {w.stale?.length ? (
