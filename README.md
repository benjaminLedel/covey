...
| 📂 **Workspace** | The agent's home directory in the browser: look through what it has lying around, drop a template or a dataset in, edit a file. Markdown, images, PDFs and tables are previewed in place. Works while the agent sleeps, and every change is recorded. |
